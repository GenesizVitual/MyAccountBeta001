            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="row" style="overflow: scroll; height: 500px">
                        @foreach($product as $data)
                                <div class="col-sm-3">
                                    <a href="#" id="add_product" @if($data->stok == 0) onclick="return confirm('Stok telah habis, silahkan menambahkan stok terlebih dahulu')" @else onclick="get_product('{{ $data->id }}')" @endif style="text-align: center">
                                        <p style="text-align: center">
                                            @if(!empty($data->gambar))
                                                <img src="{{ asset('produk/'.$data->gambar) }}" style="width: 100%; padding-top: 15%;">
                                            @else
